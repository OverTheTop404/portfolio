...
const IconList = [
  ...
  { icon: "gitIcon", viewBox: "0 0 88 88", name: "Git" },
  ...
  //{ icon: "html5", viewBox: "0 0 44 44", name: "" },
  //{ icon: "css3", viewBox: "0 0 53 53", name: "" },
  //{ icon: "photoshop", viewBox: "0 0 90 90", name: "Photoshop" },
  //{ icon: "reactNative", viewBox: "0 0 120 106", name: "" },
  //{ icon: "gitSystem", viewBox: "0 0 116 120", name: "" },
  //{ icon: "expressjs", viewBox: "0 0 120 28", name: "ExpressJs" },
];
